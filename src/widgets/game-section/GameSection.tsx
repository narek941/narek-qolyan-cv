...
import {
  ...
  MongoDB,
  GraphQL,
} from "@/shared/ui/tech-icons/TechnologyIcons";
import type { Card } from "@/shared/types/components.types";
  ...
  return (
    <div className="relative overflow-x-hidden">
      <div className="max-w-4xl mx-auto relative z-10">
        ...
        <div className="liquid-glass-strong rounded-[2.5rem] p-8 md:p-12 relative overflow-hidden">
