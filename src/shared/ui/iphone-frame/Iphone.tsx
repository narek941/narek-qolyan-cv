// Ported from ScrollX UI (MIT) — https://scrollxui.dev/docs/components/iphone
'use client';
...
export function Iphone({
  ...
  // Time renders only after mount — SSR markup stays deterministic.
  ...
  return (
    ...
    >
      ...
      {showHeader && (
        <div
          className='absolute z-[15] flex items-center justify-between pointer-events-none text-[10px] sm:text-[11px] font-semibold px-3.5 sm:px-[1.375rem]'
          style={{
            left: `${calcX}%`,
            top: `${calcY}%`,
            width: `${calcW}%`,
